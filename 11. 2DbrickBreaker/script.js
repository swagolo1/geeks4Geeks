...
let BALL_RADIUS = 10; 
let BALL_VX = 8; //velocity
let BALL_VY = 3; //velocity
// padde
...
function x() { 
	...
	Text.draw('Game starts in 1 secs!'); 
	canvas.removeEventListener('click', x); 
} 
canvas.addEventListener('click', x); 
canvas.addEventListener('mousemove', e => paddle.move(e)); 
